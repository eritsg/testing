...
<div class="container">
     <div class="row">
         <div class="col-6 offset-3">
            <h1 class="display-6 text-center font-monospace text-decoration-underline">Connexion</h1>
            <?php if(isset($error)){ ?>
            ...
            <?php } ?>
             <form action="<?php $_SERVER['PHP_SELF'];?>" method="post">
                ...
                <button type="submit" class="btn btn-primary  col-12 mt-2" name="submitted">Se connecter</button>
                </form>
         </div>
     </div>
 </div>
